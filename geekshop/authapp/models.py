...
class ShopUserProfile(models.Model):
    ...
    # photo_50 = models.ImageField(ShopUser.avatar, blank=True)
    # photo_50 = ShopUser.avatar


    # photo_50 = models.ImageField(upload_to='user_avatars', default=ShopUser.avatar)
